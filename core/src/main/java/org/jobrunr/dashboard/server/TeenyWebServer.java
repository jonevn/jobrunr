...
import org.jobrunr.utils.ForkJoinWorkerThreadFactoryWithContextClassloader;
...
public class TeenyWebServer {
	...
	public TeenyWebServer(int port) {
		try {
			...
			executorService = new ForkJoinPool(Runtime.getRuntime().availableProcessors(),
				new ForkJoinWorkerThreadFactoryWithContextClassloader(), null, true);
