...
class KtJobScheduler(
    ...
    private val jobFilterUtils: JobFilterUtils
) {

    constructor(storageProvider: StorageProvider) : this(
        storageProvider,
        JobFilterUtils(JobDefaultFilters(listOf()))
    ) {
    }

    constructor(storageProvider: StorageProvider, jobFilters: List<JobFilter>) : this(
        storageProvider,
        JobFilterUtils(JobDefaultFilters(jobFilters))
    ) {
    }
